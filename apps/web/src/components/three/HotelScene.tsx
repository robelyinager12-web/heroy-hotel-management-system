...
function SceneContent() {
  return (
    <>
      ...
      <directionalLight position={[8, 12, 6]} intensity={1.8} color="#f0d488" castShadow />
      <pointLight position={[-6, 4, -4]} intensity={1.2} color="#a78bfa" />
...
export function HotelScene() {
  return (
    <div className="h-[500px] w-full overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-b from-[#1c1f29] to-[#0b0c10]">
